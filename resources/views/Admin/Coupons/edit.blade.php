            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-label" type="radio" name="discount_target" id="order_total" value="order_total" {{ $coupon->discount_target == 'order_total' ? 'checked' : '' }}>
                        <label class="form-label" for="order_total">Tổng đơn hàng</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-label" type="radio" name="discount_target" id="shipping_fee" value="shipping_fee" {{ $coupon->discount_target == 'shipping_fee' ? 'checked' : '' }}>
