    ...
    <form action="{{ route('admin.coupons.store') }}" method="POST" class="p-4 border rounded bg-light">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="discount_value" id="discount_value" value="{{ old('discount_value') }}" class="form-control" required>
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="usage_limit" id="usage_limit" value="{{ old('usage_limit') }}" class="form-control" required>
            </div>

            <div class="col-md-6 mb-3">
                <label for="usage_per_user" class="form-label">Số lần sử dụng mỗi người:</label>
                <input type="number" name="usage_per_user" id="usage_per_user" value="{{ old('usage_per_user') }}" class="form-control" required>
            </div>

            <div class="col-md-6 mb-3">
                <label for="user_voucher_limit" class="form-label">Loại giới hạn người dùng:</label>
                <select name="user_voucher_limit" id="user_voucher_limit" class="form-select" onchange="toggleUserSelection()">
            ...
            <div class="col-md-6 mb-3" id="userSelection" style="display: none;">
                ...
                <select name="selected_users[]" id="selected_users" class="form-select" multiple>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="max_discount_amount" id="max_discount_amount" value="{{ old('max_discount_amount') }}" class="form-control">
            </div>
