                                        ...
                                        @if (!request('status') || $return->status == request('status'))
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#viewModal{{ $return->id }}">
                                                        Xem
                                                    </button>
                                                                    ...
                                                                    <form action="{{ route('admin.returns.refunded', $return->id) }}" method="POST" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="file" name="refund_image" id="refu
nd_image" class="form-control" accept="image/*" required>
                                                                                @error('refund_image')
                                                    ...
                                                    <div class="modal fade" id="viewModal{{ $return->id }}" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="viewModalLabel">Chi tiết yêu cầu hoàn hàng #{{ $return->id }}</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">×</span>
                                                                    </button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <p><strong>ID Đơn hàng:</strong> {{ $return->order->id }}</p>
                                                                            <p><strong>Lý do hoàn hàng:</strong> {{ $return->reason }}</p>
                                                                            <p><strong>Số tài khoản:</strong> {{ $return->bank_account }}</p>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            @if ($return->image)
                                                                                <img src="{{ Storage::url($return->image) }}" alt="Ảnh minh chứng" class="img-fluid" style="max-width: 100%;">
                                                                            @else
